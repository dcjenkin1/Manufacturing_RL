...
plt.savefig(model_dir+"results/lambda_preturn_loss.png",dpi=600)

plt.figure()
plt.plot(dqn_loss_arr)
plt.savefig(model_dir+"results/dqn_loss.png",dpi=600)
...
plt.savefig(model_dir+"results/value_estimate.png",dpi=600)
...
plt.legend()
plt.savefig(model_dir+"results/absolute_error.png",dpi=600)
...
plt.legend()
plt.axhline(linewidth=1, color='grey')
plt.savefig(model_dir+"results/DQN_predictron_error_dif.png",dpi=600)
...
plt.legend()
plt.axhline(linewidth=1, color='grey')
plt.savefig(model_dir+"results/predictron_error.png",dpi=600)
...
plt.savefig(model_dir+"results/wafer_lateness.png",dpi=600)
